      ...
      <div className="abhi-pipeline-card">
        <div className="card-body p-0">
          <div className="abhi-pipeline-table-wrapper">
            ...
            <div className="abhi-pipeline-table-body-scroll" style={{ height: tableHeight }} >
              <table className="table table-hover abhi-pipeline-table">
                <tbody>
                  {isLoading ? (
                    <tr>
                      <td colSpan="2" className="text-center py-5">
                        <div className="abhi-spinner-border text-primary" role="status">
                    ...
                    <tr>
                      <td colSpan="2" className="text-center py-4">
                        <div className="d-flex flex-column align-items-center justify-content-center py-4">
                          ...
                          <button className="btn btn-primary px-3 py-2 abhi-create-pipeline-btn" onClick={() => setEditPipeline({})} >
                    ...
                    pipelines.map((pipeline) => (
                      <tr key={pipeline._id} className="abhi-pipeline-table-row">
                        <td className="ps-4">
                        ...
                        <td className="text-end pe-4">
                          <button className="btn btn-outline-primary btn-sm me-2 abhi-pipeline-action-btn" title="Edit" onClick={() => handleEdit(pipeline)} >
                            <i className="bi bi-pencil-square"></i>
                          </button>

                          <button className="btn btn-outline-danger btn-sm abhi-pipeline-action-btn" title="Delete" onClick={() => handleDelete(pipeline._id, pipeline.pipelineName)} >
